...
function Stake() {
  ...
  const onChangeStake = async action => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(ohmBalance, "gwei"))) {
      return dispatch(error(t`You cannot stake more than your MUSH balance.`));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(sohmBalance, "gwei"))) {
      return dispatch(error(t`You cannot unstake more than your sMUSH balance.`));
    }
                ...
                <Grid container spacing={2} alignItems="flex-start">
                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="stake-index">
                      ...
                      <Typography variant="h4">
                        {currentIndex ? (
                          <span data-testid="index-value">{trim(currentIndex, 1)} MUSH</span>
                        ) : (
              ...
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="body1" component="span">
                    <Trans>Connect your wallet to stake MUSH</Trans>
                  </Typography>
                </div>
              ) : (
                <>
                    ...
                    <Box className="stake-action-row " display="flex" alignItems="center">
                      ...
                      <TabPanel value={view} index={0} className="stake-tab-panel">
                        {isAllowanceDataLoading ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "staking", t`Stake MUSH`)}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                      ...
                      <TabPanel value={view} index={1} className="stake-tab-panel">
                        {isAllowanceDataLoading ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "unstaking", t`Unstake MUSH`)}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                  ...
                  <div className={`stake-user-data`}>
                    <div className="data-row">
                      ...
                      <Typography component="span" variant="body1" id="user-balance">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} MUSH</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography component="span" variant="body1" id="user-staked-balance">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{sohmBalance} sMUSH</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography component="span" variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sMUSH</>}
                      </Typography>
                    </div>
